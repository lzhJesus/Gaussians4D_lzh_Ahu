...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # for knnloss
        self.knn_loss_use = True
        self.knn_loss_until = 10000
        self.num_clusters = 1000
        self.lambda_knn_weight = 2000
        self.knn_loss_weight = 0.001
        self.knn_neighbor_num = 8
        #for entropyloss
        self.entropy_loss_weight = 0.005
        ...
        self.discriminator_loss_weight = 0.001
        self.discriminator_until = 7000
        # self.discriminator_over = 10000
        self.discriminator_loss_interval = 3
